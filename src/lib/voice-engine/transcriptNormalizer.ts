...
// Deterministisch. Geen AI. Alleen dictionary replacements.
// ============================================================
...
// Langste eerst zodat "frikadellen special" vóór "frikadellen" matcht
const SORTED_MAP = [...PHONETIC_MAP].sort((a, b) => b[0].length - a[0].length);

export function normalizeTranscript(text: string): string {
  let t = text.toLowerCase().trim();

  // Stap 1: dictionary replacements (langste eerst)
  ...
  // Stap 2: dubbele spaties opruimen
