...
export const translations = {
  ...
  hero: {
    ...
    proof: { nl: 'Bewezen door klanten: 40% meer afspraken.', en: 'Proven by customers: 40% more appointments.', fr: 'Prouvé par les clients : 40 % de rendez-vous en plus.', de: 'Bewährt bei Kunden: 40 % mehr Termine.' },
  ...
  frituur: {
    ...
    noCommission: { nl: '0% commissie', en: '0% commission', fr: '0 % de commission', de: '0 % Provision' },
