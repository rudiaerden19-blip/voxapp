...
export const BUSINESS_TYPES: Record<string, BusinessTypeConfig> = {
  ...
  hotel: {
    ...
    icon: '🏨',
    category: 'horeca',
    modules: ['reservations', 'services', 'staff'],
  ...
  garage: {
    ...
    icon: '🚗',
    category: 'diensten',
    modules: ['appointments', 'services', 'workorders', 'vehicles'],
  ...
  loodgieter: {
    ...
    icon: '🔧',
    category: 'diensten',
    modules: ['appointments', 'services', 'workorders'],
  ...
  immo: {
    ...
    icon: '🏠',
    category: 'vastgoed',
    modules: ['appointments', 'services', 'properties', 'staff'],
