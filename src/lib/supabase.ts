...
interface Database {
  public: {
    Tables: {
      businesses: {
        Row: { id: string; user_id: string; name: string; type: string; phone: string | null; email: string | null; address: string | null; opening_hours: Json | null; subscription_status: string; trial_ends_at: string | null; elevenlabs_agent_id: string | null; stripe_customer_id: string | null; stripe_subscription_id: string | null; created_at: string; updated_at: string }
